...
[CustomEditor(typeof(CameraTargetZoneChanger))]
public class EditorCameraZoneChanger : Editor {
    private CameraTargetZoneChanger m_target;
    private void OnSceneGUI()
    {
        m_target = (CameraTargetZoneChanger) target;
